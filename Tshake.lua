...
local url,res = http.request('http://80.211.231.137/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_Storm ~= true then
send(msg.chat_id_,msg.id_,'- يرجى الاشتراك في قناة البوت \n- لتتمكن من استخدام البوت بصوره طبيعيه \n- القناة » [@Stormcli] ⚜️')   
return false 
end
function Function_Tshake(extra, result, success)
...
🌐┇Storm TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/stormcli)

📋┇ [TshAkE Dev](https://t.me/stormcli)

📁┇ [Source  Files](https://t.me/Tshake_info)

🌐┇ [TshAkE iNDT](https://t.me/stormcli/4611)
